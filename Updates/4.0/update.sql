...
ALTER TABLE `languages` CHANGE `flag` `image` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;
ALTER TABLE `users` CHANGE `login_by` `provider` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;
...
ALTER TABLE `users` ADD `country_name` VARCHAR(255) NULL DEFAULT NULL AFTER `country_code`, ADD `state` VARCHAR(255) NULL DEFAULT NULL AFTER `country_name`,
ADD `city` VARCHAR(255) NULL DEFAULT NULL AFTER `state`,
ADD `zip` VARCHAR(40) NULL DEFAULT NULL AFTER `city`;
...
ALTER TABLE `general_settings` ADD `available_version` VARCHAR(40) NOT NULL DEFAULT '4.0' AFTER `system_info`;
...
ALTER TABLE `users` ADD `dial_code` TEXT NULL DEFAULT NUll AFTER `country_code`;
ALTER TABLE `users` CHANGE `dial_code` `dial_code` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '0';
UPDATE `gateways` SET `crypto` = '0' WHERE `gateways`.`alias` = 'TwoCheckout';
DELETE FROM gateways WHERE `gateways`.`id` = 8;
...
UPDATE `general_settings` SET `firebase_config` = '{\"apiKey\":\"----------\",\"authDomain\":\"---------\",\"projectId\":\"--------\",\"storageBucket\":\"-------\",\"messagingSenderId\":\"--------\",\"appId\":\"--------\",\"measurementId\":\"------\",\"serverKey\":\"--------\"}' WHERE `general_settings`.`id` = 1;
ALTER TABLE `deposits` CHANGE `final_amo` `final_amount` DECIMAL(28,8) NOT NULL DEFAULT '0.00000000', CHANGE `btc_amo` `btc_amount` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;
...
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Balance Added' WHERE `notification_templates`.`id` = 1;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Balance Subtracted' WHERE `notification_templates`.`id` = 2;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Deposit successful' WHERE `notification_templates`.`id` = 3;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Deposit Request Approved' WHERE `notification_templates`.`id` = 4;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Deposit Request Rejected' WHERE `notification_templates`.`id` = 5;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} Password Reset Code' WHERE `notification_templates`.`id` = 7;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Support Ticket Replied' WHERE `notification_templates`.`id` = 9;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Withdrawal Request Approved' WHERE `notification_templates`.`id` = 12;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Withdrawal Request Rejected' WHERE `notification_templates`.`id` = 13;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - Requested for withdrawal' WHERE `notification_templates`.`id` = 14;
UPDATE `notification_templates` SET `push_title` = '{{subject}}' WHERE `notification_templates`.`id` = 15;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - KYC Approved' WHERE `notification_templates`.`id` = 16;
UPDATE `notification_templates` SET `push_title` = '{{site_name}} - KYC Rejected' WHERE `notification_templates`.`id` = 17;
UPDATE `notification_templates` SET `push_title` = 'Balance Transfer' WHERE `notification_templates`.`id` = 19;
UPDATE `notification_templates` SET `push_title` = 'Balance Receive' WHERE `notification_templates`.`id` = 20;
UPDATE `notification_templates` SET `push_title` = 'Referral commission got successfully' WHERE `notification_templates`.`id` = 21;
UPDATE `notification_templates` SET `push_title` = 'You\'ve subscribed successfully' WHERE `notification_templates`.`id` = 22;

UPDATE `notification_templates` SET `push_title` = 'PTC Advertisement Approved' WHERE `notification_templates`.`id` = 23;
UPDATE `notification_templates` SET `push_title` = 'PTC Advertisement Rejected' WHERE `notification_templates`.`id` = 24;


INSERT INTO `frontends` (`data_keys`, `data_values`, `seo_content`, `tempname`, `slug`, `created_at`, `updated_at`) VALUES 
('register_disable.content', '{\"has_image\":\"1\",\"heading\":\"Registration Currently Disabled\",\"subheading\":\"Page you are looking for doesn\'t exit or an other error occurred or temporarily unavailable.\",\"button_name\":\"Go to Home\",\"button_url\":\"\\/\",\"image\":\"66488b6067df71716030304.png\"}', NULL, 'ptc_diamond', '', '2024-05-18 11:05:04', '2024-05-18 11:05:04');

INSERT INTO `frontends` (`data_keys`, `data_values`, `seo_content`, `tempname`, `slug`, `created_at`, `updated_at`) VALUES 
('register_disable.content', '{\"has_image\":\"1\",\"heading\":\"Registration Currently Disabled\",\"subheading\":\"Page you are looking for doesn\'t exit or an other error occurred or temporarily unavailable.\",\"button_name\":\"Go to Home\",\"button_url\":\"\\/\",\"image\":\"66488b6067df71716030304.png\"}', NULL, 'ptc_prime', '', '2024-05-18 11:05:04', '2024-05-18 11:05:04');

INSERT INTO `frontends` (`data_keys`, `data_values`, `seo_content`, `tempname`, `slug`, `created_at`, `updated_at`) VALUES 
('register_disable.content', '{\"has_image\":\"1\",\"heading\":\"Registration Currently Disabled\",\"subheading\":\"Page you are looking for doesn\'t exit or an other error occurred or temporarily unavailable.\",\"button_name\":\"Go to Home\",\"button_url\":\"\\/\",\"image\":\"66488b6067df71716030304.png\"}', NULL, 'basic', '', '2024-05-18 11:05:04', '2024-05-18 11:05:04');
